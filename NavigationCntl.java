...
public class NavigationCntl {
    ...
    public void getScheduleCtrl(Stage theStage){
        ScheduleCtrl.getScheduleCntl(theStage);
    }
    public void getLogActivityCntl(Stage theStage){
        LogActivityCntl.getLogActivityCntl(theStage);
    }
